  ...
  const columns = [
    {
      ...
      render: (text, record, index) => {
        const color = blueShades[index % blueShades.length]; // 循环使用颜色数组中的颜色
        return (
          <div>
            <Avatar
              size="small"
  ...
  return (
    <>
      <TagInput
        ...
        addOnBlur
      />
      <Table columns={columns} dataSource={userInfo} pagination={{pageSize: 8}} />
    </>
  );
}
